...
{
    public class CompanyOfHeroesProfileInitRepository : IInitialSqlLiteDatabase
    {
        private readonly ApplicationDbContext _applicationDbContext;

        public CompanyOfHeroesProfileInitRepository(ApplicationDbContext applicationDbContext)
        {
